...
public class Chat_Database_Execute extends SQLiteOpenHelper {
    ...
    public String CREATE_QUERY_RECENT_CHATS="CREATE TABLE IF NOT EXISTS " +RecentChatsInfo.TABLE_NAME+"("+RecentChatsInfo.FLAG+" INTEGER,"+RecentChatsInfo.GROUP_ID +" TEXT PRIMARY KEY,"+RecentChatsInfo.OPPOSITE_PERSON_NUMBER+" TEXT,"+RecentChatsInfo.SENDER+" TEXT,"+RecentChatsInfo.LAST_UPDATED+" DATETIME);";
